  ...
  return (
    <>
      <div className=" relative textrotate h-full w-full text-center bg-white">
        ...
        <h1 className=" pg2Text text-black text-[40vw] pt-[5vw] leading-[32vw] font-[anzo4]">
          IMPACTFUL
        </h1>
        <h1 className=" pg2Text text-black text-[40vw] leading-[32vw] font-[anzo4]">
          DESIGN
        </h1>
        <h1 className=" pg2Text text-black text-[40vw] leading-[32vw] font-[anzo4]">
          IS THE
        ...
        <div className="  relative z-10  bg-white scale-50 mr-[5vw] mt-[4vw]">
          <svg
      ...
      <div className="  relative z-10 bg-black h-[2px] w-1/3 left-1/2 -translate-x-1/2 mt-[3vw] "></div>
    </>
  );
};
